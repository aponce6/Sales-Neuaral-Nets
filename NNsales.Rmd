...
salesNet = neuralnet(salesTgt~miles+debt+income, data = normalizedTrainDataSet, hidden=c(3,2), stepmax=1.e6, rep=1, linear.output = FALSE)
```
...
x = filter(testDataSet, income>5000 & debt < 9000 & miles > 25)
